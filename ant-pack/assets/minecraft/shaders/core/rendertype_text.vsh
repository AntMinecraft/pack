// Credits: https://github.com/McTsts/mc-core-shaders/
#version 150
...
void main() {
    ...
    if (
        Position.z == 0.0 // check if the depth is correct (0 for gui texts)
        ...
        // move the vertices offscreen, idk if this is a good solution for that but vec4(0.0) doesnt do the trick for everyone
